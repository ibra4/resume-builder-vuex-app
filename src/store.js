...
export default new Vuex.Store({
  state: {
    ...
    LinksList: [
      { label: "Facebook", type: "facebook", icon: "facebook-square", username: "" },
      { label: "Instagram", type: "Instagram", icon: "instagram", username: "" },
      { label: "Twitter", type: "Twitter", icon: "twitter", username: "" },
      { label: "Snapchat", type: "Snapchat", icon: "snapchat-square", username: "" },
      { label: "YouTube", type: "YouTube", icon: "youtube", username: "" },
      { label: "Whatsapp", type: "Whatsapp", icon: "whatsapp", username: "" },
      { label: "WeChat", type: "WeChat", icon: "weixin", username: "" },
      { label: "Pinterest", type: "Pinterest", icon: "pinterest-square", username: "" },
      { label: "Tumblr", type: "Tumblr", icon: "tumblr-square", username: "" },
      { label: "SoundCloud", type: "SoundCloud", icon: "soundcloud", username: "" },
      { label: "Spotify", type: "Spotify", icon: "spotify", username: "" },
      { label: "LinkedIn", type: "LinkedIn", icon: "linkedin", username: "" },
      { label: "Skype", type: "Skype", icon: "skype", username: "" },
      { label: "Github", type: "Github", icon: "github-square", username: "" },
      { label: "Bitbucket", type: "Bitbucket", icon: "bitbucket", username: "" },
      { label: "StackOverflow", type: "StackOverflow", icon: "stack-overflow", username: "" },
      { label: "JsFiddle", type: "JsFiddle", icon: "jsfiddle", username: "" }
    ],
    SkillsList: [
